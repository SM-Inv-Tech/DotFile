...
alias ali="ssh xiaohai@139.196.192.31"
alias 80='ssh -X xiaohai@14.17.86.80'
...
export PYTHONPATH=/home/xiaohai/CTA/py:$PYTHONPATH
...
export LIBRARY_PATH=$FMTSYS/lib64:$LIBRARY_PATH
...
################## xhquant #####################
export PATH=/home/xiaohai/xhquant/script:$PATH

##################### CTP ######################
export CTPSYS=/opt/ZZZ/CTP
export LD_LIBRARY_PATH=$CTPSYS/lib:$LD_LIBRARY_PATH
export CPLUS_INCLUDE_PATH=$CTPSYS/include:$CPLUS_INCLUDE_PATH

#################### SQLITE ####################
export SQLITESYS=/opt/ZZZ/SQLite/install
export LD_LIBRARY_PATH=$SQLITESYS/lib:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=$SQLITESYS/lib64:$LD_LIBRARY_PATH
export PATH=$SQLITESYS/bin:$PATH
export CPLUS_INCLUDE_PATH=$SQLITESYS/include:$CPLUS_INCLUDE_PATH

#################### pybind ####################
export PYBIND11SYS=/opt/ZZZ/pybind11/install
export CPLUS_INCLUDE_PATH=$PYBIND11SYS/include:$CPLUS_INCLUDE_PATH

################### rapidjson ##################
export RAPIDJSONSYS=/opt/ZZZ/rapidjson/install
export CPLUS_INCLUDE_PATH=$RAPIDJSONSYS/include:$CPLUS_INCLUDE_PATH
export LIBRARY_PATH=$RAPIDJSONSYS/lib:$LIBRARY_PATH

################### treelite ###################
export TREELITESYS=/opt/ZZZ/treelite/install
export CPLUS_INCLUDE_PATH=$TREELITESYS/include:$CPLUS_INCLUDE_PATH
export LD_LIBRARY_PATH=$TREELITESYS/lib64:$LD_LIBRARY_PATH
